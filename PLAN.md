...
| 8 | **Hospital handover PDF** — xhtml2pdf (pure-Python; substitutes WeasyPrint, see docs/setup.md), all §8 sections, S3 + signed link, email (Mailhog dev) + WhatsApp dispatch | Generate PDF, open via 15-min link, contains every §8 field | Twilio (WhatsApp) |
